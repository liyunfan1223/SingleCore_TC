    ...
    namespace priest
    {
        ...
        public:
            AiObjectContextInternal()
            {
                ...
                creators["power word: shield on medium health below"] = &AiObjectContextInternal::power_word_shield_on_medium_health;
        ...
        private:
            ...
            static Action* power_word_shield_on_medium_health(PlayerbotAI* ai) { return new CastPowerWordShieldOnMediumHealth(ai); }
